...
Future<void> _seedDefaultCategories(AppDatabase db) async {
  final expenseRoots = [
    (id: 'cat-food', name: 'Food & Dining', type: CategoryType.expense, icon: 0xe533),
    (id: 'cat-transport', name: 'Transport', type: CategoryType.expense, icon: 0xe531),
    (id: 'cat-shopping', name: 'Shopping', type: CategoryType.expense, icon: 0xe59c),
    (id: 'cat-bills', name: 'Bills & Utilities', type: CategoryType.expense, icon: 0xe5fb),
    (id: 'cat-health', name: 'Health & Medical', type: CategoryType.expense, icon: 0xe3f3),
    (id: 'cat-entertainment', name: 'Entertainment', type: CategoryType.expense, icon: 0xe63b),
    (id: 'cat-education', name: 'Education', type: CategoryType.expense, icon: 0xe80c),
    (id: 'cat-personal', name: 'Personal Care', type: CategoryType.expense, icon: 0xe7fd),
    (id: 'cat-travel', name: 'Travel', type: CategoryType.expense, icon: 0xe1d5),
    (id: 'cat-other-exp', name: 'Other Expense', type: CategoryType.expense, icon: 0xe8b8),
  ];

  final incomeRoots = [
    (id: 'cat-salary', name: 'Salary', type: CategoryType.income, icon: 0xe263),
    (id: 'cat-freelance', name: 'Freelance', type: CategoryType.income, icon: 0xe8d5),
    (id: 'cat-business', name: 'Business Income', type: CategoryType.income, icon: 0xe1d3),
    (id: 'cat-investment-inc', name: 'Investment Returns', type: CategoryType.income, icon: 0xe8dc),
    (id: 'cat-gifts', name: 'Gifts Received', type: CategoryType.income, icon: 0xe40c),
    (id: 'cat-other-inc', name: 'Other Income', type: CategoryType.income, icon: 0xe8b8),
  ];
...
Future<void> _insertSecurityConfigRow(AppDatabase db) async {
  ...
  await db.into(db.securityConfigs).insert(
